            ...
            <div class="netflix-shows">
              ...
              <div class="n-director-wrapper">
                ...
                <div class="n-director">
                  <img src="<?php echo getActorByName($show->director, $apiKey);?>" alt="<?php echo htmlspecialchars($show->director);?>">
                ...
                <div class="n-cast">
                  <?php foreach ($castArray as $castMember):?>
                    <div class="cast-member">
                      <img src="<?php echo getActorByName($castMember, $apiKey);?>" alt="<?php echo htmlspecialchars($castMember);?>">
